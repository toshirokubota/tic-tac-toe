                    ...
                    <div className="radio-group my-4">
                        <label htmlFor="player-mark-x">
                            <input type='radio' id='player-mark-x' name='player-mark' value='x'
                                ...
                                aria-label="choose X as player 1's mark"/>
                            <svg width="64" height="64" xmlns="http://www.w3.org/2000/svg" role='img' aria-label='X icon'>
                        ...
                        <label htmlFor="player-mark-o">
                            <input type='radio' id='player-mark-o' name='player-mark' value='o'
                                onChange={handleChange}
                                aria-label="choose O as player 1's mark"/>
                            <svg width="64" height="64" xmlns="http://www.w3.org/2000/svg" role='img' aria-label='O icon'>
